...
- *Don't use rule-of-thumb cutoffs* to interpret your item/model fit
  ...
  - **WRONG**: PCA eigenvalue < 2.0 (or 1.5)
...
- **Johansson** [-@johanssonDetectingItemMisfit2025] — on power to detect misfit due to multidimensionality, using infit, outfit, and item–restscore (Goodman–Kruskal's $\gamma$).
...
- Paper compares conditional and **unconditional** infit/outfit
- Unconditional item fit is inconsistent. 
...
- Usually judged by several indices — **RMSEA, SRMR, CFI**
...
- **Simulation-based cutoffs should be used** [@mcneishDirectDiscrepancyDynamic2024]
  - R package `dynamic`; simpler with `easyRasch2` and jamovi module

. . .

- **Remember to use a correct estimator for ordinal data**
  - WLSMV, ULSMV, DWLS, etc
...
* [https://orcid.org/0000-0003-1669-592X](https://orcid.org/0000-0003-1669-592X)
* [https://ki.se/en/people/magnus-johansson-3](https://ki.se/en/people/magnus-johansson-3)

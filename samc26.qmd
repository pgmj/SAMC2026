...
**Simulation** [(parametric bootstrap)]{style="font-size:0.5em"}
...
- [Click [here](https://pgmj.github.io/rasch_bayes_comp.html) for a comparison.]{style="font-size:0.75em"}
:::
::::
...
:::: {.columns}
::: {.column width="50%"}
[Conditional infit]{style="font-size:1.0em; margin-bottom: 0.1em"}

![](images/sim_infit_3items.png)

:::

::: {.column width="50%" .fragment}
[Conditional outfit]{style="font-size:1.0em; margin-bottom: 0.1em"}

![](images/sim_outfit_3items.png)
:::
::::
...
![](images/q3matrix.png){width="85%"}
![](images/q3hist.png){width="85%"}
:::
